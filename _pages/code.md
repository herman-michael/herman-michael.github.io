...
|:----------:| :-------------------------------------------------- | :------------------------- |:----------------------:|
| Dec, 2020  | Federated learning via posterior averaging          | fedpa                      | 
<a class="github-button" href="https://github.com/herman-michael/DSS-CNN" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star herman-michael/DSS-CNN on GitHub">Star</a>           |
